<?php 
	...
	$mapAPI = 'AIzaSyD9P25HJahbIQQkRrminWGhk2A49Dw-z5w'; /* API Key: https://developers.google.com/maps/documentation/javascript/get-api-key */
	$mapWidth = '300';
    $mapHeight = '200';
    $mapZoom = '15';
...
<?php if ($mapType == 1){ /*Static Map*/ ?>
	<img src="<?php echo 'http://maps.googleapis.com/maps/api/staticmap?center=' . $fullAddressMapFormat . '&zoom=15&scale=false&size=300x200&maptype=roadmap&format=png&visual_refresh=true&markers=size:mid%7Ccolor:0xff0000%7Clabel:%7C' . $fullAddressMapFormat ?>&key=<?php echo $mapAPI; ?>" class="img-responsive">
<?php } ?>
...
<?php } ?>
<?php if ($mapType == 5){ /* Multiple Markers */ ?>
	<?php include(locate_template('inc/maps/multiple.php')); ?>
<?php } ?>
